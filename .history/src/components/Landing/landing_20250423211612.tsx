          ...
          <div className="flex flex-col lg:flex-row items-center gap-12">
            ...
            <div className="w-full lg:w-1/2 relative">
              ...
              <div className="relative z-10 bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl overflow-hidden border border-slate-100">
                <Image
                  src="/Landing.png?height=500&width=600&text=Plataforma+DonaVida"
        ...
        <div className="container mx-auto max-w-6xl px-4">
          ...
          >
            <TestimonialCard
              ...
              image="/Landing.png?height=60&width=60&text=MG"
            />
            <TestimonialCard
              ...
              image="/Landing.png?height=60&width=60&text=CR"
            />
            <TestimonialCard
              ...
              image="/Landing.png?height=60&width=60&text=LM"
            />
          </div>
        </div>
      </section>
