      ...
      <CardContent className="p-6 space-y-4">
        ...
        <div className="flex items-center gap-3 pt-2">
          <div className="w-12 h-12 rounded-full overflow-hidden">
            <Image src={image || "https://res.cloudinary.com/ineoslive/image/upload/w_72,c_fill,g_auto,q_auto/IneosCapitalv3/globalassets/icons/f40-2b.svg"} alt={name} width={48} height={48} />
          </div>
          <div>
