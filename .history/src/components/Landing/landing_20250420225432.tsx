          ...
          <div className="flex flex-col lg:flex-row items-center gap-12">
            ...
            <div className="w-full lg:w-1/2 relative">
              ...
              <div className="relative z-10 bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl overflow-hidden border border-slate-100">
                <Image
                  src="/placeholder.svg?height=500&width=600&text=Plataforma+DonaVida"
        ...
        <div className="container mx-auto max-w-6xl px-4">
          ...
          <div
            className={`grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 transition-all duration-1000 ${
              isVisible.features ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10 bg-white/80"
            }`}
          >
            <FeatureCard
      ...
      <section className="py-16 bg-slate-50/50 backdrop-blur-sm">
        <div className="container mx-auto max-w-6xl px-4">
          <div className="text-center mb-12">
            <h2 className="text-2xl font-bold text-slate-800 mb-4">Organizaciones que confían en nosotros</h2>
          </div>
          <div className="flex flex-wrap justify-center items-center gap-8 md:gap-16">
            {[1, 2, 3, 4, 5].map((i) => (
              <div key={i} className="grayscale hover:grayscale-0 transition-all duration-300">
                <Image
                  src={`/placeholder.svg?height=60&width=120&text=ONG+${i}`}
                  alt={`Organización ${i}`}
                  width={120}
                  height={60}
                />
    ...
    <Card className="border-slate-100 shadow-sm hover:shadow-md transition-all duration-300">
      <CardContent className="p-6 space-y-4">
        <div className="flex justify-start">
          <svg className="h-8 w-8 text-slate-300" fill="currentColor" viewBox="0 0 32 32" aria-hidden="true">
