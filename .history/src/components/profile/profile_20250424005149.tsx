...
const isDonor = (
  profile: UserProfile | CharityProfile
...
export default function UserProfile() {
  ...
  const [profileData, setProfileData] = useState<
    UserProfile | CharityProfile | null
  >(null);
  ...
  useEffect(() => {
    if (getResponse) {
      ...
      if (userData) {
        ...
        console.error(
          "No se pudieron extraer datos de usuario de la respuesta"
        );
      }
    } else {
            ...
            {isCharity(profileData) && (
              <div className="mt-4 pt-4 border-t border-slate-100">
                ...
                <p className="text-slate-600">
                  {profileData.descripcion || "Sin descripción disponible."}
                </p>
              </div>
            )}
          </div>
