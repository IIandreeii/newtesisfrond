          ...
          <div className="flex flex-col items-center space-y-4">
            <div className="relative">
              <div className="w-24 h-24 rounded-full overflow-hidden border-4 border-white shadow-md">
                <Image
                  src={profileData.avatar || `/placeholder.svg?height=120&width=120&text=${profileData.nombre?.charAt(0) || 'U'}`}
            ...
            <div className="space-y-1">
              ...
              <div className="flex flex-wrap items-center justify-center md:justify-start gap-2 mt-2">
                ...
                <Badge className="bg-green-100 text-green-700 border-green-200">
                  ID: {profileData.id ? profileData.id.substring(0, 8) + "..." : ""}
                </Badge>
              </div>
            </div>
          </div>
        ...
        <CardContent className="p-6">
          ...
          <div className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {userType === "donor" ? (
                <>
                  <InfoItem label="ID" value={profileData.id || ""} />
...
// ... resto de los componentes auxiliares sin cambios
