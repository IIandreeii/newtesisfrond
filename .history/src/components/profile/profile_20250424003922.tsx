              ...
              {userType === "donor" ? (
                <>
                  <h1 className="text-2xl font-bold text-slate-800">
                    {profileData.nombre} {userType === "donor" && "apellido" in profileData ? profileData.apellido : ""}
                  </h1>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {userType === "donor" ? (
                <>
                  ...
                  <InfoItem label="Nombre completo" value={`${profileData.nombre || ""} ${userType === "donor" && "apellido" in profileData ? profileData.apellido || "" : ""}`} />
