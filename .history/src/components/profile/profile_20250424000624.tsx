...
import { useProfileService, ProfileData, UserProfile, CharityProfile } from "./service/profile"

// Funciones auxiliares para verificar el tipo de perfil
function isDonor(profile: ProfileData): profile is UserProfile {
  return profile.userType === "donor";
}

function isCharity(profile: ProfileData): profile is CharityProfile {
  return profile.userType === "charity";
}
            ...
            <div className="space-y-1">
              ...
              <div className="flex flex-wrap items-center justify-center md:justify-start gap-2 mt-2">
                <Badge className="bg-sky-100 text-sky-700 border-sky-200">
                  {isDonor(profileData) ? "Donante" : "Organización"}
                </Badge>
              </div>
            </div>
          </div>
