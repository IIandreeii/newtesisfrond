...
import { useProfileService, export interface UserProfile {
, CharityProfile } from "./service/profile"
...
export default function UserProfile() {
  ...
  useEffect(() => {
    if (getResponse) {
      const userData = getResponse.charity || getResponse.user || (getResponse.data as ProfileData)?.charity || (getResponse.data as ProfileData)?.user;
