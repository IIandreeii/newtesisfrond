...
export default function UserProfile() {
  ...
  useEffect(() => {
    // Ejecutar la función getProfile cuando el componente se monte
    getProfile();
  }, []);
  
  // Mostrar el estado de carga y los datos
  console.log("Estado de carga:", loader);
  console.log("Datos del perfil:", getResponse);
  
  // Si quieres ver cuando cambia getResponse
  useEffect(() => {
    if (getResponse) {
      console.log("Datos actualizados del perfil:", getResponse);
    }
  }, [getResponse]);
