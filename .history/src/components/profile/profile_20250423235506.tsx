...
import { useProfileService, ProfileData } from "./service/profile"; // Importa ProfileData

export default function UserProfile() {
  const [userType, setUserType] = useState<"donor" | "charity">("donor");
  const [profileData, setProfileData] = useState<ProfileData | null>(null); // Cambiado de any a ProfileData | null
  ...
  useEffect(() => {
    ...
    loadProfile();
  }, [getProfile]); // Agrega getProfile como dependencia
