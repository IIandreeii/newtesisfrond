...
export default function UserProfile() {
  ...
  useEffect(() => {
    if (getResponse) {
      ...
      if (getResponse.data) {
        console.log("Datos recibidos:", getResponse.data);
        
        // Extrae los datos del usuario o de la caridad según corresponda
        const userData = 'charity' in getResponse.data 
        ...
        if (userData && 'userType' in userData) {
