...
export default function UserProfile() {
  ...
  useEffect(() => {
    // Llamamos a la función getProfile solo una vez al montar el componente
    getProfile()
    // eslint-disable-next-line react-hooks/exhaustive-deps
  }, []) // Array de dependencias vacío para ejecutar solo al montar
  
  // Añade este efecto para loguear solo cuando getResponse cambie
  useEffect(() => {
    if (getResponse !== null) {
      console.log("getResponse actualizado:", getResponse)
    }
  }, [getResponse])
