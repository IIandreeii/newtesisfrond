      ...
      <div className="flex flex-col lg:flex-row items-center gap-8">
        ...
        <div className="w-full lg:w-1/2 space-y-8 p-4">
          <div className="space-y-4">
            <div className="flex items-center gap-3">
              <div className="relative">
                <Heart className="h-10 w-10 text-sky-400 fill-sky-400" />
                <Heart className="h-6 w-6 text-pink-300 fill-pink-300 absolute -top-2 -right-2" />
              </div>
              <h1 className="text-3xl font-bold text-slate-800">DonaVida</h1>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="flex items-start gap-3 p-4 rounded-lg bg-white/80 backdrop-blur-sm border border-sky-100 shadow-sm">
            ...
            <div className="flex items-start gap-3 p-4 rounded-lg bg-white/80 backdrop-blur-sm border border-green-100 shadow-sm">
            ...
            <div className="flex items-start gap-3 p-4 rounded-lg bg-white/80 backdrop-blur-sm border border-pink-100 shadow-sm">
        ...
        <div className="w-full lg:w-1/2 p-4">
          <Card className="border-slate-100 shadow-lg transition-all duration-300 bg-white/90 backdrop-blur-sm relative overflow-hidden">
            <div className="absolute top-0 right-0 w-32 h-32 bg-sky-50 rounded-full blur-3xl -translate-x-1/2 -translate-y-1/2 opacity-50"></div>
            <div className="absolute bottom-0 left-0 w-32 h-32 bg-green-50 rounded-full blur-3xl translate-x-1/2 translate-y-1/2 opacity-50"></div>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="space-y-2">
                  <div className="flex items-center justify-between">
                    ...
                    <a href="#" className="text-xs text-sky-500 hover:text-sky-600 transition-colors">
