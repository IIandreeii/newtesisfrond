...
export default function LoginForm() {
  ...
  // Eliminado isLoadingView ya que no se usa
  ...
  // Corregimos las dependencias faltantes
  useEffect(() => {
  ...
  }, [loader, getResponse, showToast, router, showError])
  ...
  const handleSubmit = async (data: LogindFormInput) => {
    setShowToast(false)
    // Eliminamos setIsLoginView ya que la variable no se usa
    ...
    try {
      ...
      // No capturamos el error en una variable ya que no lo usamos
